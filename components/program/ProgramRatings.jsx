...
const ProgramRatings = () => {
  ...
  return (
    <div id="ratings" className="py-[80px]">
      ...
      <div className="mt-[24px]  relative" dir="rtl">
       <SenjaReviews/>
      </div>
    </div>
  );
...
function SampleNextArrow(props) {
  ...
  return (
    <div
      onClick={onClick}
      className="absolute top-[-60px] scale-x-[-1] left-0 z-[999] bg-white"
    >
...
function SamplePrevArrow(props) {
  ...
  return (
    <div
      className="absolute top-[-60px] scale-x-[-1] left-[48px] z-[999] bg-white"
      onClick={onClick}
    >
      <div className="w-[40px] h-[40px] cursor-pointer hover:scale-[0.95] duration-300 ease-in relative">
        <Image
