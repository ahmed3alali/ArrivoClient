    ...
    return (
      <div className="flex flex-col sm:flex-row items-start gap-8">
        ...
        <div id="blog-content" className="flex flex-col gap-[20px]">
          ...
          <div className="text-black text-[14px] sm:text-[16px]">
          الوجهة :  <span className="text-[#F08631] "> طرابزون </span>  2023 فبراير 22
          </div>
          <p>{blog.blog.Body.slice(0, 150)}</p>
          <button
            onMouseOver={() => setArrowWhite(true)}
            onMouseOut={() => setArrowWhite(false)}
            className="flex items-center gap-x-[4px] mb-10 py-[8px] px-[20px] border border-orange rounded-[8px] border-solid text-orange hover:bg-[#F08631] hover:text-white transtion duration-200 w-full sm:w-fit justify-center sm:justify-start"
          >
            أكمل القراءة
            <svg
              width="24"
